...
int gp_bayer_expand (const unsigned char *input, int w, int h, unsigned char *output,
                     BayerTile tile);
int gp_bayer_decode (const unsigned char *input, int w, int h, unsigned char *output,
		     BayerTile tile);
